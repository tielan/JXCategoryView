...
#import "JXCategorySegmentCell.h"
#import "JXCategorySegmentCellModel.h"

@interface JXCategorySegmentCell ()
@property (nonatomic, strong) CALayer *maskLayer;

@end

@implementation JXCategorySegmentCell
...
- (void)reloadData:(JXCategoryBaseCellModel *)cellModel {
    ...
    JXCategorySegmentCellModel *myCellModel = (JXCategorySegmentCellModel *)cellModel;
